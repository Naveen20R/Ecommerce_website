      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-sm-8" style={description}>
            ...
            <hr />
            <p>Size :<span style={{ fontWeight: "bold" }}> {size}</span> </p>
            <div className='btn' >
              <button onClick={() => { setSize('X-small') }} disabled style={{ backgroundColor: '#FFCCCB' }}>X-Small</button>
              <button onClick={() => { setSize('Small') }}>Small</button>
              <button onClick={() => { setSize('Medium') }}>Medium</button>
              <button onClick={() => { setSize('Large') }}>Large</button>
              <button onClick={() => { setSize('X-Large') }}>X-Large</button>
              <button onClick={() => { setSize('XX-Large') }}>XX-Large</button>
            </div>
            <hr />
            <div className='btncb'>
              <nav>
